...
from investors.portfolio_manager import portfolio_management_agent
from investors.technicals import technical_analyst_agent
from investors.risk_manager import risk_management_agent
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=float,
        default=100_000.0,
        help="Initial cash position. Defaults to £100_000.0)"
    )
    parser.add_argument(
        "--margin-requirement",
        type=float,
